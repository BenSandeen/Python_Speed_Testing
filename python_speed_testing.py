...
# # 5TH (about 1/3 as fast as other three)
# t0 = time.clock()
...
# #4TH (about 1/3 as fast as fastest 3)
# t0 = time.clock()
# for i in xrange(1000000):
#     random.gauss(0,5)
# print time.clock() - t0
...
# # 4TH slightly better, but still not even close
# s=np.sqrt
# t0 = time.clock()
# for i in xrange(1,1000000):
#     s(i)
...
# # 4TH (not surprisingly) about 20% slower than 3RD place
# t0 = time.clock()
...
# # 2ND almost 10% faster than 3RD place
# t0 = time.clock()
# for i in xrange(100000):
#     for Nchars in xrange(10):
#         if Nchars>4:
...
# # 1ST marginally faster than 2ND place
# t0 = time.clock()
# for i in xrange(100000):
#     for Nchars in xrange(10):
#         if Nchars>8:
...
# summ = 0
# for i in xrange(100):
#     [addone,addtwo][a](summ)
#     a = ~a
# print(time.clock() - t0)

# ####################################

# # 3RD about 2X slower than bitwise shifts (below)
# t0 = time.clock()
...
# # 1ST about 12% faster than x**y function
# t0 = time.clock()
# for j in xrange(1000000):
# 	for i in xrange(10):
# 	    x = 2<<((i))
...
# # 1ST faster than 2ND place by about 40%
# t0 = time.clock()
# i = 0
# while i <= 10000000:
#     x = i
...
# # 2ND slightly slower than 1ST place one
# t0 = time.clock()
# for i in range(10000000):
# 	i=i+i
# print(time.clock() - t0)
...
# # 3RD about 5% slower than the 2ND place one
# t0 = time.clock()
# for i in range(10000000):
# 	i=i<<1
# print(time.clock() - t0)
...
# # 3RD just slightly slower than sets
# L.clear()
# t0 = time.clock()
# for i in range(10000000):
# 	L.append(i)
...
# # 2ND actually slower by about 12.5%
# t0 = time.clock()
# x=list(np.array(L)*2)
# print(time.clock() - t0)
...
# print(time.clock() - t0)
# #########
# # 1ST about 40% faster using the python lists
# t0 = time.clock()
# zip(L,M)
# # print zip(L[:10],M[:10])
# print(time.clock() - t0)
